    ...
    <footer className="bg-teal-900">
        <div className="mx-auto max-w-screen-2xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
            ...
            <div>
                ...
                <div className="h-[120px] w-[120px] rounded-full p-1 ">
                    <Link href="/">
                    <img
                        src="/image/logo2.png"
                        alt="logo"
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2 lg:grid-cols-4">
                <div>
                    <p className="font-medium text-yellow-600">Services</p>
                ...
                <div>
                    <p className="font-medium text-yellow-600">Company</p>
                ...
                <div>
                    <p className="font-medium text-yellow-600">Helpful Links</p>
                ...
                <div>
                    <p className="font-medium text-yellow-600">Legal</p>
