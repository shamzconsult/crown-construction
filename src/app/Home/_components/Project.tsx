    ...
    <div className='bg-teal-900'>
      <div className='max-w-screen-xl mx-auto py-10'>
        <div className='flex justify-between p-10'>
          <h2 className='text-2xl md:text-5xl text-white'>Our Offerings</h2>
          <Link 
            href="/gallery"
        ...
        <div className=" gap-4 px-10">
          ...
          <div className="flex gap-4 w-full h-96 mt-10">
            <Image 
                ...
                width={300} 
                height={200} 
                className="w-1/2 md:w-1/3 h-96 object-cover " 
            />
            <Image 
                src="/image/smart-home.jpg" 
                alt="Project 4" 
                width={300} 
                height={200} 
                className="w-1/2 md:w-1/3 h-96 object-cover " 
            ...
            <Image 
                ...
                width={300} 
                height={200} 
                className="md:w-1/3 h-96 object-cover hidden md:block " 
            />
          </div>
        </div>
      </div>
